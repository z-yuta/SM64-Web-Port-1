...
function findWasmBinary() {
  return locateFile('sm64.us.f3dex2e.wasm');
}
...
var ASM_CONSTS = {
 ...
 11647680: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 11647763: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 11647832: () => { return window.innerWidth; },  
 11647862: () => { return window.innerHeight; },  
 11647893: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }
};
